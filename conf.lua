function love.conf(t)
    t.identity = "LD34"                   -- The name of the save directory (string)
    t.version = "0.9.2"                -- The LÖVE version this game was made for (string)
    t.console = false                  -- Attach a console (boolean, Windows only)
 
    t.window.title = "HeXor"        -- The window title (string)
    t.window.icon = "gfx/icon.png"                -- Filepath to an image to use as the window's icon (string)
